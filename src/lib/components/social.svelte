<div class="flex flex-col justify-center items-center space-x-2 space-y-2 p-4">
    <div class="flex flex-row flex-wrap justify-center items-center">
        <div class="flex flex-col justify-center p-2">
            <a href="https://www.reddit.com/user/toonoeichi/" aria-label="Reddit link">
                <img class="w-[2rem]" src="icon/reddit.svg" alt="Reddit logo" />
            </a>
        </div>
        <div class="flex flex-col justify-center p-2">
        ...
        <div class="flex flex-col justify-center p-2">
            <a href="https://youtube.com/@toonstorytime" aria-label="Youtube link">
                <img class="w-[2rem]" src="icon/youtube.svg" alt="Youtube logo" />
            </a>
        </div>
        <div class="flex flex-col justify-center p-2">
            <a href="https://twitch.tv/toonstorytime/" aria-label="Twitch link">
                <img class="w-[2rem]" src="icon/twitch.svg" alt="Twitch logo" />
            </a>
        </div>
        <div class="flex flex-col justify-center p-2">
        ...
        <div class="flex flex-col justify-center p-2">
            <a href="msnim:chat?contact=kritthapath@escargot.chat" aria-label="MSN link">
                <img class="w-[2rem]" src="icon/msnim.png" alt="MSN logo" />
            </a>
        </div>
    </div>
</div>